...
BUNDLE_MANIFEST_SCHEMA = "goalzendo.g00f_source_bundle_payload_manifest"
RECEIPT_SCHEMA = "goalzendo.g00f_extracted_source_bundle_receipt"
...
def prepare(args: argparse.Namespace) -> dict[str, Any]:
    ...
    supplied = {
        "bootstrap": args.actual_bootstrap.resolve(),
        "launcher": args.actual_launcher.resolve(),
        "watchdog": args.actual_watchdog.resolve(),
    }
...
def main() -> int:
    parser = argparse.ArgumentParser(prog="g00f_bundle_bootstrap")
    ...
    try:
        ...
        print(f"g00f_bundle_bootstrap: error: {error}", file=sys.stderr)
        return 2
